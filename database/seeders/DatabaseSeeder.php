    ...
    public function run(): void
    {
        $this->call([
           ...
           // AWCFishingGameSeeder::class,
            ...
            HACKSAWSlotSeeder::class,
            HackSawOtherSeeder::class,
            ...
            EvolutionBigTimeGamingSlotSeeder::class,
            EvolutionLiveCasinoSeeder::class,
            EvolutionNetenSlotSeeder::class,
            NoLimitCitySlotSeeder::class,
            RedTigerSlotSeeder::class,
